    ...
    return (
      ...
      `}
        >
            ...
            {/* Layer 1: Glass Overlay (Background Color) */}
            <div className="absolute inset-0 z-[1] bg-[var(--lg-bg-color)]" />

            {/* Layer 2: Glass Specular (Highlights/Borders) */}
            <div className="absolute inset-0 z-[2] rounded-[inherit] overflow-hidden shadow-[inset_1px_1px_0_var(--lg-highlight),inset_0_0_5px_var(--lg-highlight)] pointer-events-none" />
