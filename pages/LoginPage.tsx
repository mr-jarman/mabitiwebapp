            ...
            <main className="flex-1 flex items-center justify-center p-6 relative z-10">
                <div className="w-full max-w-md perspective-1000">
                    ...
                    >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={isLoggingIn}
                                            className={`w-full py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-500 dark:to-blue-600 text-white font-bold text-lg shadow-xl shadow-blue-500/30 transition-all duration-300 ${isLoggingIn
                        ...
                        >
                            <div className="relative rounded-3xl p-10 bg-white/70 dark:bg-black/60 border border-white/20 dark:border-white/10 shadow-2xl backdrop-blur-xl hover:shadow-purple-500/20 transition-all duration-500 max-h-[85vh] overflow-y-auto scrollbar-hide ">
                                {/* Animated border gradient */}
